...
\item \textbf{研究内容与成果：} 构建融合多模态眼底影像与临床文本的高质量图文数据集，基于Qwen3-VL-8B-Instruct，采用LoRA参数高效微调开发AdaPUV，实现多模态大模型的领域适配。通过跨模态迁移、模态与文本消融及数据效率实验，系统分析文本引导对多模态融合的作用，评估模型在缺失模态条件下的鲁棒性与迁移能力。内部测试准确率达\textbf{96.28\%}，AUROC达\textbf{0.9893}。
\end{itemize}
\projectsep

...
\textbf{BMVC（CCF C）} \hfill 2026\\
\textbf{Beyond Classification: Structured Supervision Aligns Visual Evidence with Medical Semantics}
\begin{itemize}[nosep]
\item \textbf{共同第一作者}，参与实验设计、代码实现与论文撰写。

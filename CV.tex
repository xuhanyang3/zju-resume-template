...
\textbf{医学视觉基础模型的跨域知识融合与心脏图像分割（OODKA）}
\begin{itemize}[nosep]
\item \textbf{项目内容：} 面向医学基础模型的心脏影像OOD泛化，融合基础模型与nnUNet专家模型，构建OODKA知识融合框架。
\item \textbf{技术与成果：} 采用结构-残差解耦、组件级知识对齐和文本语义引导重融合，实现参数高效适配；MedSAM2平均Dice达92.9\%，HD95降至3.45\,mm。
\end{itemize}
